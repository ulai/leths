...
return {
    ...
    this.create({
      ...
      drawBlock: b => {
        ...
        _.filter(clients.light, l => l.pos.x == b.x && l.pos.y == b.y)[0]
          .send({feature:'light', cmd: 'fade', to: 1, t: 0})
      },
      clear: () => {
        _.each(clients.light, l => {
          l.send({feature:'light', cmd: 'fade', to: 0, t: 0})
        })
      }
    })
  },
  options: {
    ...
    theme: 'headless', // The theme name or a theme object
    ...
    speed: 5, // The speed of the game. The higher, the faster the pieces go.
  ...
  theme: function(newTheme){
    ...
    if( typeof this._theme === 'undefined' || this._theme === null ) {
      this._theme = $.extend(true, {}, BlockrainThemes['headless']);
      this.options.theme = 'headless';
    }
